    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                    <div>
                        <h4 class="center grey-text text-darken-2 card-title">派遣先情報を追加する</h4>
                    </div>
                    <hr>
                    <div class="card-content">
                        <form action="{{route('workplaces.store')}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                {{-- workplace_id --}}
                                <input type="hidden" name="workplace_id" value="{{$new_workplaceid}}">
