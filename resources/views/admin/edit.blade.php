    ...
    <div class="container">
        <div class="row">
            <div class="card col s12 m12 l12 xl12 mt-20">
                    <div>
                        <h4 class="center grey-text text-darken-2 card-title">管理者情報を更新する</h4>
                    </div>
                    <hr>
                        ...
                        <form action="{{route('admins.update', $admin->admin_id)}}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                    ...
                                    <input type="email" name="mail_address" id="mail_address" value="{{Request::old('mail_address') ? : $admin->mail_address}}">
                                    <label for="mail_address">メールアドレス</label>
                                    <span class="{{$errors->has('mail_address') ? 'helper-text red-text' : ''}}">{{$errors->first('mail_address') ? $errors->first('mail_address') : ''}}</span>
                                </div>
                                ...
                                <div class="file-field input-field col s12 m8 offset-m2 l8 offset-l2 xl8 offset-xl2">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input type="text" class="file-path validate" value="{{old('picture') ? : $admin->picture}}">
